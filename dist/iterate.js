...
(function () {
    ...
    var __ = new function () {
        ...
        me.download = function (content, fileName, type) {
            ...
            var fileMap = {
                ...
                'json': { ext: '.json', encoding: 'data:application/json;charset=utf-8', parse: function parse(data) {
                        return me.is.string(data) ? data : JSON.stringify(data);
                    } }
            };
        ...
        me.guid = function (seperator, track) {
            ...
            if (track) {
                if (me.guidMap[track] && me.guidMap[track][guid]) return me.guid(seperator, track);else {
                    me.guidMap[track] = {};
        ...
        me.match = function (obj1, obj2, options) {
            ...
            var flag = true;
            if (event.checkType) if (!me.is.sameType(obj1, obj2)) return false;
            if (!me.is.set(obj1) && me.is.set(obj2) || me.is.set(obj1) && !me.is.set(obj2)) return false;
        ...
        me.removeAt = function (obj, key) {
            if (me.is.array(obj)) {
                if (key > -1) obj.splice(key, 1);
            } else if (me.is.object(obj)) delete obj[key];
            return obj;
        };
        me.search = function (obj, func, options) {
            ...
            if (me.is.function(func)) {
                ...
                if (idx > -1) ret = opt.getKey ? idx : obj[idx];
            } else if (me.is.object(obj)) {
                me.all(obj, function (x, y, e) {
                    if (x == func) {
                        ret = opt.getKey ? y : x;
